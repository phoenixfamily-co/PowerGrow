...
def generate_pdf_file(request, pk):
    ...
    p.drawRightString(540, 310, text_converter("۴-۲: متقاضی متعهد مي شود تا نهایت امانت داری را در طي مدت قرارداد رعایت فرماید و مبلغ"))
    p.drawRightString(540, 290, text_converter("هرگونه خسارت به تجهیزات و تاسیسات ورزشی را پرداخت کند."))
    p.drawRightString(540, 270, text_converter("۴-۳: مجموعه ورزشی حجاب میتواند در صورت نیاز به سالن، با اعلام حداقل دو هفته زودتر،"))
    ...
    p.drawRightString(540, 750, text_converter("ماده ۷: فسخ قرارداد:"))
    ...
    p.drawRightString(540, 640, text_converter("۷-۲: عدم پرداخت به موقع حق استفاده (ماده ۳ )"))
    p.drawRightString(540, 620, text_converter("لازم به ذکر است پرداخت‌آنلاین در سایت به منزله قبولی و امضا تمامی قوانین و مقررات فوق می باشد"))
    p.drawRightString(540, 610, text_converter("ماده ۸: این قرارداد شامل ۸ ماده و در دو نسخه تنظيم شده است که هر کدام حكم واحد را دارند."))
    p.drawRightString(540, 550, text_converter("مهر و امضا پیمانکار مجم.عه حجاب"))
    p.drawRightString(200, 550, text_converter("مهر و امضا متقاضی"))
