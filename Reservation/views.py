...
def generate_pdf_file(request, pk):
    ...
    p.drawRightString(540, 390, text_converter("۴-۱: میزان ساعت هر جلسه برای استفاده ی متقاضي ۹۰ دقيقه"))
    p.drawRightString(540, 370, text_converter("آموزشی امکان پذیر نیست مگر با مجوز کتبی داده شده توسط مجموعه و حداکثر نفرات استفاده کننده"))
    p.drawRightString(540, 350, text_converter("از سوي متقاضی در هر سانس اعلام باید گردد."))
