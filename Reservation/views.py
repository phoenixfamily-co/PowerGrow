...
def generate_pdf_file(request, reservation):
    ...
    p.drawRightString(350, 750, text_converter("بسمه تعالی"))
    p.drawRightString(360, 730, text_converter("مجموعه ورزشی حجاب"))
    p.drawRightString(370, 710, text_converter("قرارداد سالن اجاره ورزشی"))
    p.showPage()
    p.save()
    buffer.seek(0)
