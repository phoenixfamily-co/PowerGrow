...
urlpatterns = [
    ...
    path('api/admin/reserve/<int:time>/', ManagerAddReservationView.as_view({'post': 'create'}),
         name='admin-reserve'),
    path('api/admin/reserve/delete/<int:pk>/', ManagerAddReservationView.as_view({'delete': 'destroy'}),
