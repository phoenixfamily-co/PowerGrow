...
urlpatterns = [
    ...
    path('api/participants/description/update/<int:pk>/', ChangeParticipantsDescription.as_view(),
         name='update-participants-description'),
    ...
    path('api/admin/participate/<int:id>/<int:session>/<int:day>/<int:start>/<str:user>/create/',
         ManagerParticipationView.as_view
         ({'post': 'create'}),
