...
urlpatterns = [
    ...
    path('api/course/name/update/<int:pk>/', CourseView.as_view({'put': 'update'}), name='update-courses-name'),
    path('api/course/gender/update/<int:pk>/', CourseView.as_view({'put': 'update'}), name='update-courses-gender'),
    path('api/course/type/update/<int:pk>/', CourseView.as_view({'put': 'update'}), name='update-courses-type'),
    path('api/course/time/update/<int:pk>/', CourseView.as_view({'put': 'update'}), name='update-courses-time'),
    path('api/course/capacity/update/<int:pk>/', CourseView.as_view({'put': 'update'}), name='update-courses-capacity'),
    path('api/course/sport/update/<int:pk>/', CourseView.as_view({'put': 'update'}), name='update-courses_sport'),
