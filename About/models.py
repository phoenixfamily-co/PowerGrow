...
class AboutUs(models.Model):
    ...
    phone = models.CharField(max_length=13, null=True, blank=True, verbose_name="مویایل")
    ...
    longitude = models.FloatField(default=0, blank=True, null=True, verbose_name="ظول جغرافیایی")
